...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 6159.198145684663; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -6585.968149989308; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 5531.171128289042; // x position of the perpendicular encoder (in tick units)
    }
