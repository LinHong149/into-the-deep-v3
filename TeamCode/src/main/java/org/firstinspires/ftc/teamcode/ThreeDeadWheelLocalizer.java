...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 6028.856800565143; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -6741.6654392678165; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 6675.591978488151; // x position of the perpendicular encoder (in tick units)
    }
