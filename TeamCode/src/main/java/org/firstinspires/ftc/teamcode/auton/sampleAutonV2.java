...
public class sampleAutonV2 extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder toFirstSample = drive.actionBuilder(new Pose2d(-52.5,-51.5,Math.toRadians(45)))
                .splineTo(new Vector2d(-48.25,-40),Math.toRadians(90))
                .waitSeconds(.1);
        TrajectoryActionBuilder dropOffFirst = drive.actionBuilder(new Pose2d(-48.25,-40,Math.toRadians(90)))
                .setReversed(true)
        ...
        TrajectoryActionBuilder toSecondSample = drive.actionBuilder(new Pose2d(-51.5,-52.5,Math.toRadians(49.5)))
                .setReversed(false)
                .splineToLinearHeading(new Pose2d(-57,-40,Math.toRadians(99)),Math.toRadians(107))
                .waitSeconds(.1);
        TrajectoryActionBuilder dropOffSecond = drive.actionBuilder(new Pose2d(-57,-40,Math.toRadians(99)))
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(-51,-53,Math.toRadians(52)),Math.toRadians(232))
                .waitSeconds(.2);
        TrajectoryActionBuilder toThirdSample = drive.actionBuilder(new Pose2d(-51,-53,Math.toRadians(52)))
                .setReversed(false)
                .splineTo(new Vector2d(-56,-40),Math.toRadians(125))
                .waitSeconds(.1);
